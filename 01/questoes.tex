...
para descrever a eficiência do algoritmo independentemente da sua implementação real
 \parencite[275--276]{sipser2012}.
...
\subsection{Modelo de computação}
Por isso, precisamos utilizar um método que independa desses detalhes de implementação discutidos, mas nos dê informação suficiente;
...
iremos nos basear numa simplificação do modelo computacional de \textcite[26]{clrs2022},
