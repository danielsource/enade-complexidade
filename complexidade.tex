...
podemos ter dificuldade em analisar o que mais importa a medida que o tamanho da entrada $n$ aumenta.
...
\[
    T(n) = n^3;
\]
sabendo que, para o nosso propósito, analisar esse novo $T(n)$ é suficiente pois a medida que $n$ aumenta,
todos os outros termos ficam menos significativos.
Essa abstração é chamada de \emph{ordem de crescimento} e pode ser denotada melhor usando $\Theta$ (ou big theta),
em vez de $T(n)$.
...
Eventualmente, mesmo com grandes constantes, um algoritmo com $\Theta(n^2)$ vai ser mais eficiente que outro com $\Theta(n^3)$.

% assintótica
% custo computacional / complexidade
% O/Omega
