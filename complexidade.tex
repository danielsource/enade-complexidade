...
poderíamos ter usado qualquer outro $O(n^k)$ em que $k \ge 2$ \parencite[57]{clrs2022}.
\pagebreak
...
um vasto conjunto de problemas de otimização é considerado intratável.
...
Na sua versão de decisão (``existe uma rota de custo no máximo $k$?''), o problema é $NP$-completo,
...
o problema é $NP$-difícil \parencite[1091--1092]{clrs2022}.
